  ...
  render() {
    return (
      <div className={bem.block()}>
        <div className={bem.element('inner-block')}>
          <Creator className={bem.element('creator')} name={<>Igor <br /> Gerasimovich</>} additionalInfo={<>Ukraine, Backend Developer <br/> (with Frontend experience)</>} />
